...
const (
	...
	ErrParseUserID     = "invalid user UUID"
	StatusRoomExists   = "chat room already exists"
)
...
const (
	...
	ErrNoRoomAccess     = "user does not have access to this room"
	ErrCreateRoom       = "failed to create chat room"
	ErrSaveMessage      = "failed to save message"
	ErrGetMessages      = "failed to get messages"
	ErrUpdateStatus     = "failed to update message status"
	ErrSendMessage      = "failed to send message"
	ErrReadMessage      = "failed to read message"
	ErrBroadcastMessage = "failed to broadcast message"
...
const (
	...
	ErrNoRoomID         = "room ID is required"
	ErrRoomFull         = "room is full"
	ErrUpgradeConn      = "failed to upgrade connection"
	StatusRoomCreated   = "chat room created"
	StatusUserConnected = "user connected to chat"
	LogRoomID           = "roomID"
	LogOtherID          = "otherID"
)
